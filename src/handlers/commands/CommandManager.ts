import { AutocompleteInteraction, Collection, CommandInteraction, type Snowflake } from "discord.js";
...
export default class CommandManager {
    ...
    static async cache(): Promise<void> {
        ...
        const filenames = CommandManager._getFilesRecursively(dirpath);
    ...
    private static _getFilesRecursively(dir: string): string[] {
        ...
        for (const file of fs.readdirSync(dir)) {
            ...
            if (fs.statSync(filepath).isDirectory()) {
                files.push(...CommandManager._getFilesRecursively(filepath));
